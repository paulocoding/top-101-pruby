...
describe "#multiply" do
  ...
  it "multiplies several numbers" do
    multiply([2,5,1,2]).should == 20
  end

  it "multiplies by 0" do
    multiply([2,5,1,0]).should == 0
  end
end

describe "#power" do
  
  it "raises one number to the 2 of 2" do
    power(2,2).should == 4
  end
  
  it "raises one 3 to the power of 3" do
    power(3,3).should == 27
  end
  
  it "raises one 3 to the power of 0" do
    power(3,0).should == 1
  end
